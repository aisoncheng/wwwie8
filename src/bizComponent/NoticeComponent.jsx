...
import { ButtonWithLoading, Input, Button, Tips ,Row ,Col, Checkbox } from '../core';
    ...
    return (
      <div className="container">
        ...
        <Checkbox
          ...
          size = {14}
        >
          <span style={{fontSize:'16px'}}>我已阅读并同意</span>
        </Checkbox>

        <Row className="buttons">
          <Col span={5} offset={7} >
            <Tips placement="top" title={!this.state.hasHistoryApply ? '没有正在申请的记录' : ''}>
              <Button type="primary" size="large" disabled={!this.state.hasHistoryApply} onClick={this.showHistoryApply}>查看当前申请</Button>
            </Tips>
          </Col>
          <Col span={5} offset={1}>
            <Tips placement="top" title={this.state.disabled ? '请勾选已阅读并同意' : ''}>
