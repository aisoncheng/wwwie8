...
import { BaseInfo, ApplyFileUpload, Declaration } from '../../common';
...
console.log(tools.PlaceOwnerRadio());
          ...
          <Row>
            ...
            <Col span={10}>
              <FormItem labelCol={{span:10}} wrapperCol={{span:14}}  label="租赁/无偿使用期限" hasFeedback={showFeed}>
                ...
                <RangePicker placeholder={'租赁（无偿使用）'} disabled={this.state.tenancyDate || !showFeed }
                   format = "yyyy-MM-dd"
